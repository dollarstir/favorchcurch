              ...
              <div class="col-md-12 col-12">
                <div class="card">
                  <div class="card-header">
                    <center><h4 class="card-title">Social Media Accounts</h4></center>
                  </div>
                    ...
                    <div class="card-body">
                      <?php
                        ...
                        while($social = mysqli_fetch_object($sql)) {
                          if(($count % 2) == 1) echo '<div class="row my-2">';
                          echo '
                              <div class="col-md-6">
                                <div class="shadow">
                                  <div class="card-header">
                                    <div style="display: inline-block;" class="tc_twitter_img_wrapper mr-2">
                                      <img style="width: 40px; height: 40px" src="../upload/' . $social->logo. '" class="twitter icon" alt="twitter icon">
                                    </div>
                                    ' . $social->title . '
                                  </div>
                                    <div class="px-2 row">
                                      ...
                                      <div class="col-md-2">
                                        <button id="' . strtolower($social->title) . '"  title="' . $social->title . '" type="button" class="btn btn-icon btn-light-primary social_button mr-1 mb-1">
