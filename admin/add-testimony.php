...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Favor chapel- Add testimony</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">NEW TESTIMONY  FORM</h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="testifrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Name </label>
